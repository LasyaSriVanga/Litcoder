# Problem Statement:
# You have a collection of candies, and each candy has a certain sweetness value. Your goal is to combine the candies to create new candies 
# until you reach a specific target sweetness level. Find how many steps need to reach candies sweetness target.
...
# You can perform the following steps: Ascending order = 2,3,4,6,7,8
...
# Exercise-1 Input: 7 1 2 3 4 5
# Note:
# Line 1 : Target of the sweetness Line 2 Each candies sweetness
# output: 3

# Exercise-2 input: 11 2 5 3 7 6 1 output: 4
